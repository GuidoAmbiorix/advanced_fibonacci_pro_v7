//+------------------------------------------------------------------+
//| WF Matrix - Strategy 3.4.26 EA
//|
//|    Generated by StrategyQuant X Build 140 for MetaTrader5 (hedged)
//|    Generated at 02/22/2026 22:36
//| 
//|    Backtested on EURUSD_M1 / H4, 2013.01.01 - 2017.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "WF_Matrix_Strategy_3_4_26";
...
input double MoveSL2BE1 = 50;        //MoveSL2BE1
...
input double MoveSL2BECoef1 = 1;        //MoveSL2BECoef1
input double ProfitTargetCoef2 = 4.9;        //ProfitTargetCoef2
input double StopLossCoef2 = 3.8;        //StopLossCoef2
...
#define ATR_1 0     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_2 1     //iCustom(NULL, 0, "SqATR", 45)
#define FIBO_1 2     //iCustom(NULL,0, "SqFibo", 6, 0, 23.6, 0)
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 20)
#define ATR_4 4     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_5 5     //iCustom(NULL, 0, "SqATR", 50)
#define FIBO_2 6     //iCustom(NULL,0, "SqFibo", 2, 0, -23.6, 0)
#define ATR_6 7     //iCustom(NULL,0, "SqATR", ATRPeriod1)
...
string sqStrategyName = "WF Matrix - Strategy 3.4.26";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(FIBO_1, 0, 0), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(FIBO_2, 0, 0) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_6, 0, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_1] = iCustom(NULL,0, "SqFibo", 6, 0, 23.6, 0);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_2] = iCustom(NULL,0, "SqFibo", 2, 0, -23.6, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_6] = iCustom(NULL,0, "SqATR", ATRPeriod1);
...
bool isFibo(uchar indyIndex){
    ...
    if(indyIndex == FIBO_2) return true;
   return false;
}
