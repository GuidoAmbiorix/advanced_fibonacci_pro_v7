...
input string CustomComment = "Strategy_2_3_27";
...
input double TrailingStopCoef1 = 1;        //TrailingStopCoef1
input int Period1 = 50;        //Period1
input int SmallestRangePeriod1 = 5;        //SmallestRangePeriod1
input double PriceEntryMult2 = 0.1;        //PriceEntryMult2
input int ExitAfterBars1 = 48;        //ExitAfterBars1
input double ProfitTargetCoef2 = 2.9;        //ProfitTargetCoef2
input double StopLossCoef2 = 3.7;        //StopLossCoef2
input double TrailingStopCoef2 = 1.9;        //TrailingStopCoef2
...
input double mmRiskedMoney = 1.0;
input int mmDecimals = 2;
input double mmLotsIfNoMM = 0.05;
input double mmMaxLots = 0.2;
...
#define HIGHEST_1 0     //iCustom(NULL,0, "SqHighest", Period1, PRICE_MEDIAN)
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 45)
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 199)
#define BOLLINGERBANDS_1 4     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_CLOSE)
#define ATR_4 5     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_5 6     //iCustom(NULL, 0, "SqATR", 50)
#define ATR_6 7     //iCustom(NULL, 0, "SqATR", 84)
...
string sqStrategyName = "Strategy 2.3.27";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 1) - (PriceEntryMult2 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_5, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_4, 1)), "Current");
      ...
      if(_ticket > 0) {
         ...
         // TrailingStop initialization
         sqSetTrailingStop(_ticket, "TrailingStopCoef2 * sqGetIndicatorValue(ATR_6, 1)", SLPTTYPE_RANGE);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 45);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 199);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(NULL, 0, "SqATR", 50);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_6] = iCustom(NULL, 0, "SqATR", 84);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef2 * sqGetIndicatorValue(ATR_4, 1)")) {
      return (ProfitTargetCoef2 * sqGetIndicatorValue(ATR_4, 1));
   }
   if(idHash == sqStringHash("StopLossCoef2 * sqGetIndicatorValue(ATR_5, 1)")) {
      return (StopLossCoef2 * sqGetIndicatorValue(ATR_5, 1));
   }
   if(idHash == sqStringHash("TrailingStopCoef2 * sqGetIndicatorValue(ATR_6, 1)")) {
      return (TrailingStopCoef2 * sqGetIndicatorValue(ATR_6, 1));
   }
