//+------------------------------------------------------------------+
//| WF Matrix - Strategy 1.2.18 EA
//|
//|    Generated by StrategyQuant X Build 140 for MetaTrader5 (hedged)
//|    Generated at 02/23/2026 01:53
//| 
//|    Backtested on GBPUSD_M1 / H4, 2013.01.01 - 2017.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "WF_Matrix_Strategy_1_2_18";
...
input double StopLossCoef1 = 1.3;        //StopLossCoef1
...
input int ExitAfterBars2 = 38;        //ExitAfterBars2
input double ProfitTargetCoef2 = 4.3;        //ProfitTargetCoef2
...
#define FIBO_1 0     //iCustom(NULL,0, "SqFibo", 6, 0, -23.6, 0)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 50)
#define ATR_4 4     //iCustom(NULL, 0, "SqATR", 144)
#define FIBO_2 5     //iCustom(NULL,0, "SqFibo", 5, 0, -23.6, 0)
#define ATR_5 6     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_6 7     //iCustom(NULL, 0, "SqATR", 40)
...
string sqStrategyName = "WF Matrix - Strategy 1.2.18";
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_2, 1)), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(FIBO_2, 0, 0), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_6, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_5, 1)), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 50);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 144);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_2] = iCustom(NULL,0, "SqFibo", 5, 0, -23.6, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(NULL, 0, "SqATR", 25);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_6] = iCustom(NULL, 0, "SqATR", 40);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef2 * sqGetIndicatorValue(ATR_5, 1)")) {
      return (ProfitTargetCoef2 * sqGetIndicatorValue(ATR_5, 1));
   }
   if(idHash == sqStringHash("StopLossCoef2 * sqGetIndicatorValue(ATR_6, 1)")) {
      return (StopLossCoef2 * sqGetIndicatorValue(ATR_6, 1));
   }
