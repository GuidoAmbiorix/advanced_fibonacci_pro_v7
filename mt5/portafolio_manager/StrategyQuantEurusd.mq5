//+------------------------------------------------------------------+
//| WF Matrix - Strategy 4.3.27 EA
//|
//|    Generated by StrategyQuant X Build 140 for MetaTrader5 (hedged)
//|    Generated at 02/24/2026 23:33
//| 
//|    Backtested on EURUSD_M1 / H4, 2012.12.31 - 2017.12.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "WF_Matrix_Strategy_4_3_27";
...
input double MoveSL2BECoef1 = 1.2;        //MoveSL2BECoef1
input double SL2BEAddPipsCoef1 = 0.2;        //SL2BEAddPipsCoef1
...
input double PriceEntryMult2 = 1.4;        //PriceEntryMult2
input int BollingerBandsPrd1 = 162;        //BollingerBandsPrd1
...
#define ATR_2 1     //iCustom(NULL, 0, "SqATR", 25)
#define PARABOLICSAR_1 2     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.10)
#define BOLLINGERBANDS_1 3     //iBands(NULL,0, BBRangePeriod1, 0, 1.6, PRICE_CLOSE)
#define ATR_3 4     //iCustom(NULL, 0, "SqATR", 30)
#define BOLLINGERBANDS_2 5     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_WEIGHTED)
...
string sqStrategyName = "WF Matrix - Strategy 4.3.27";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_1, 0, 1) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1)))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_2, 1 + 1, 1) + (PriceEntryMult2 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_3, 1)), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBRangePeriod1, 0, 1.6, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_WEIGHTED);
