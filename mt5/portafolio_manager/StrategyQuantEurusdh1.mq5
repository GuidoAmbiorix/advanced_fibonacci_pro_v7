...
//|    Generated at 02/25/2026 00:20
//| 
//|    Backtested on EURUSD_M1 / H1, 2013.05.01 - 2020.07.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_1_5_16";
...
input double PriceEntryMult1 = 1.2;        //PriceEntryMult1
input int ATRPeriod1 = 14;        //ATRPeriod1
input double ProfitTargetCoef2 = 2.6;        //ProfitTargetCoef2
input double StopLossCoef2 = 2;        //StopLossCoef2
...
#define FIBO_1 3     //iCustom(NULL,0, "SqFibo", 6, 0, -23.6, 0)
#define ATR_4 4     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define FIBO_2 5     //iCustom(NULL,0, "SqFibo", 1, 0, 23.6, 0)
...
string sqStrategyName = "Strategy 1.5.16";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(FIBO_1, 0, 0) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_4, 0, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL,0, "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_2] = iCustom(NULL,0, "SqFibo", 1, 0, 23.6, 0);
