...
input string CustomComment = "Strategy_5_4_25";
...
input double StopLossCoef2 = 2.9;        //StopLossCoef2
input double PriceEntryMult2 = 2.1;        //PriceEntryMult2
...
#define ATR_2 1     //iCustom(NULL, 0, "SqATR", 35)
#define FIBO_1 2     //iCustom(NULL,0, "SqFibo", 6, 0, -23.6, 0)
#define ATR_3 3     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_4 4     //iCustom(NULL, 0, "SqATR", 40)
#define FIBO_2 5     //iCustom(NULL,0, "SqFibo", 2, 0, 100.0, 0)
...
string sqStrategyName = "Strategy 5.4.25";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(FIBO_2, 0, 0) - (PriceEntryMult2 * sqGetIndicatorValue(ATR_3, 0, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 40);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_2] = iCustom(NULL,0, "SqFibo", 2, 0, 100.0, 0);
