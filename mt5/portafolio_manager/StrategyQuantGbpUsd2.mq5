...
//|    Generated at 02/25/2026 00:34
//| 
//|    Backtested on GBPUSD_M1 / H1, 2013.05.01 - 2020.07.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_3_9_15";
...
input double MoveSL2BECoef1 = 1.1;        //MoveSL2BECoef1
input double SL2BEAddPipsCoef1 = 0.15;        //SL2BEAddPipsCoef1
input double ProfitTargetCoef1 = 2.8;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.2;        //StopLossCoef1
input double PriceEntryMult1 = 2.3;        //PriceEntryMult1
input int ATRPeriod1 = 20;        //ATRPeriod1
input double ProfitTargetCoef2 = 4.5;        //ProfitTargetCoef2
input double StopLossCoef2 = 3.4;        //StopLossCoef2
input double PriceEntryMult2 = 1.8;        //PriceEntryMult2
input int ATRPeriod2 = 30;        //ATRPeriod2
...
input double mmRiskPercent = 1.0;
...
#define FIBO_1 2     //iCustom(NULL,0, "SqFibo", 5, 0, 61.8, 0)
#define ATR_3 3     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_4 4     //iCustom(NULL, 0, "SqATR", 50)
#define FIBO_2 5     //iCustom(NULL,0, "SqFibo", 2, 0, 23.6, 0)
#define ATR_5 6     //iCustom(NULL,0, "SqATR", ATRPeriod2)
...
string sqStrategyName = "Strategy 3.9.15";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(FIBO_1, 0, 0) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_3, 0, 1))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(FIBO_2, 0, 0) + (PriceEntryMult2 * sqGetIndicatorValue(ATR_5, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_4, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_1] = iCustom(NULL,0, "SqFibo", 5, 0, 61.8, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL,0, "SqATR", ATRPeriod1);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(NULL,0, "SqATR", ATRPeriod2);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("StopLossCoef2 * sqGetIndicatorValue(ATR_4, 1)")) {
      return (StopLossCoef2 * sqGetIndicatorValue(ATR_4, 1));
   }
