...
//|    Generated at 02/26/2026 10:10
//| 
//|    Backtested on XAUUSD / M30, 2013.05.01 - 2020.07.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_5_2_27";
...
input double PriceEntryMult2 = 2.2;        //PriceEntryMult2
input double ProfitTargetCoef2 = 2.3;        //ProfitTargetCoef2
input double StopLossCoef2 = 1.2;        //StopLossCoef2
...
#define FIBO_1 0     //iCustom(NULL,0, "SqFibo", 1, 0, -38.2, 0)
...
#define FIBO_2 4     //iCustom(NULL,0, "SqFibo", 2, 0, -261.8, 0)
...
string sqStrategyName = "Strategy 5.2.27";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(FIBO_2, 0, 0) + (PriceEntryMult2 * sqGetIndicatorValue(ATR_1, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_3, 1)), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[FIBO_1] = iCustom(NULL,0, "SqFibo", 1, 0, -38.2, 0);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_2] = iCustom(NULL,0, "SqFibo", 2, 0, -261.8, 0);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("StopLossCoef2 * sqGetIndicatorValue(ATR_3, 1)")) {
      return (StopLossCoef2 * sqGetIndicatorValue(ATR_3, 1));
   }
   if(idHash == sqStringHash("TrailingStop1")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), TrailingStop1));
   }
