...
//|    Generated at 01/25/2026 18:38
//| 
//|    Backtested on EURUSD_M1 / M5, 2013.05.01 - 2020.07.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_4_3_20";
...
input int KAMAERPeriod1 = 35;        //KAMAERPeriod1
input int KAMAShortPeriod1 = 36;        //KAMAShortPeriod1
input int KAMALongPeriod1 = 192;        //KAMALongPeriod1
...
input int BBRangePeriod1 = 68;        //BBRangePeriod1
...
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", Period1, PRICE_WEIGHTED)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BBRangePeriod1, 0, 2.1, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 14)
#define ATR_3 5     //iCustom(NULL, 0, "SqATR", 199)
...
string sqStrategyName = "Strategy 4.3.20";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(KAMA_1, 0, 1), 6) < NormalizeDouble((double) sqWeekly(NULL,0, "Low", 1), 6))
      &&   (sqIsGreaterPercentile("sqWeekly(NULL,0,\"Low\", 1)",73.1,955,1)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 1) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1)))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBRangePeriod1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 14);
