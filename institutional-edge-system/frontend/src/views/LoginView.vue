  ...
  <div class="min-h-screen bg-background flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-xl shadow-card border border-slate-200 p-8">
      <div class="text-center mb-8">
        ...
        <p class="text-slate-500 text-sm font-mono tracking-wide">PROFESSIONAL TRADING TERMINAL</p>
      </div>
      ...
      <div class="mt-6 text-center">
        <router-link to="/register" class="text-xs text-slate-500 hover:text-accent transition-colors">
